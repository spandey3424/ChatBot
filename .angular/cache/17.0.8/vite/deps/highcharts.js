 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        class l extends e2 {
          ...
          htmlCss(t3) {
            ...
            return s2 && (delete t3.width, this.textWidth = h(r2) || void 0, e3 = true), t3?.textOverflow === "ellipsis" && (t3.whiteSpace = "nowrap", t3.overflow = "hidden"), n(this.styles, t3), o(i3, t3), e3 && this.htmlUpdateTransform(), this;
          }
          htmlGetBBox() {
            let { element: t3 } = this;
          ...
          htmlUpdateTransform() {
            ...
            let { element: t3, renderer: e3, rotation: i3, styles: s2, textAlign: n2 = "left", textWidth: a2, translateX: h2 = 0, translateY: l2 = 0, x: d = 0, y: c = 0 } = this, p = { left: 0, center: 0.5, right: 1 }[n2], u = s2?.whiteSpace;
        ...
        class N {
          ...
          translate(t3, e3, i3, s2, o2, r2) {
            ...
            if (!A(a2))
              return NaN;
            let h2 = n2.minPixelPadding, l2 = (n2.isOrdinal || n2.brokenAxis?.hasBreaks || n2.logarithmic && o2) && n2.lin2val, d2 = 1, c2 = 0, p2 = s2 && n2.old ? n2.old.transA : n2.transA, u2 = 0;
          ...
          updateNames() {
            ...
            i3 > 0 && (Object.keys(e3.keys).forEach(function(t4) {
              ...
              e4.xIncrement = null, (!e4.points || e4.isDirtyData) && (t3.max = Math.max(t3.max, e4.xData.length - 1), e4.processData(), e4.generatePoints()), e4.data.forEach(function(i4, s2) {
                let o2;
                i4?.options && void 0 !== i4.name && void 0 !== (o2 = t3.nameToX(i4)) && o2 !== i4.x && (i4.x = o2, e4.xData[s2] = o2);
              });
            }));
          }
          setAxisTranslation() {
          ...
          setTickInterval(t3) {
            let { categories: e3, chart: i3, dataMax: s2, dataMin: o2, dateTime: r2, isXAxis: n2, logarithmic: a2, options: h2, softThreshold: l2 } = this, d2 = A(this.threshold) ? this.threshold : void 0, c2 = this.minRange || 0, { ceiling: p2, floor: u2, linkedTo: g2, softMax: f2, softMin: m2 } = h2, b2 = A(g2) && i3[this.coll]?.[g2], v2 = h2.tickPixelInterval, k2 = h2.maxPadding, C2 = h2.minPadding, w2 = 0, T2, P2 = A(h2.tickInterval) && h2.tickInterval >= 0 ? h2.tickInterval : void 0, L2, O2, D2, j2;
            if (r2 || e3 || b2 || this.getTickAmount(), D2 = E(this.userMin, h2.min), j2 = E(this.userMax, h2.max), b2 ? (this.linkedParent = b2, T2 = b2.getExtremes(), this.min = E(T2.min, T2.dataMin), this.max = E(T2.max, T2.dataMax), h2.type !== b2.options.type && S(11, true, i3)) : (l2 && y(d2) && A(s2) && A(o2) && (o2 >= d2 ? (L2 = d2, C2 = 0) : s2 <= d2 && (O2 = d2, k2 = 0)), this.min = E(D2, L2, o2), this.max = E(j2, O2, s2)), A(this.max) && A(this.min) && (a2 && (this.positiveValuesOnly && !t3 && 0 >= Math.min(this.min, E(o2, this.min)) && S(10, true, i3), this.min = x(a2.log2lin(this.min), 16), this.max = x(a2.log2lin(this.max), 16)), this.range && A(o2) && (this.userMin = this.min = D2 = Math.max(o2, this.minFromRange() || 0), this.userMax = j2 = this.max, this.range = void 0)), M(this, "foundExtremes"), this.adjustForMinRange(), A(this.min) && A(this.max)) {
              if (!A(this.userMin) && A(m2) && m2 < this.min && (this.min = D2 = m2), !A(this.userMax) && A(f2) && f2 > this.max && (this.max = j2 = f2), e3 || this.axisPointRange || this.stacking?.usePercentage || b2 || !(w2 = this.max - this.min) || (!y(D2) && C2 && (this.min -= w2 * C2), y(j2) || !k2 || (this.max += w2 * k2)), !A(this.userMin) && A(u2) && (this.min = Math.max(this.min, u2)), !A(this.userMax) && A(p2) && (this.max = Math.min(this.max, p2)), l2 && A(o2) && A(s2)) {
                let t4 = d2 || 0;
          ...
          setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.minorTickInterval = "auto" === s2 && this.tickInterval ? this.tickInterval / t3.minorTicksPerMajor : s2, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3)
              ...
              if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                ...
                h2 = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t3.units), this.min, this.max, t3.startOfWeek, this.ordinal?.positions, this.closestPointRange, true);
          ...
          adjustTickAmount() {
            let t3 = this, { finalTickAmt: e3, max: i3, min: s2, options: o2, tickPositions: r2, tickAmount: n2, thresholdAlignment: a2 } = t3, h2 = r2?.length, l2 = E(t3.threshold, t3.softThreshold ? 0 : null), d2, c2, p2 = t3.tickInterval, u2, g2 = () => r2.push(x(r2[r2.length - 1] + p2)), f2 = () => r2.unshift(x(r2[0] - p2));
          ...
          setScale() {
            ...
            o2 || i3 || s2 || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (e3 && "yAxis" === t3 && e3.buildStacks(), this.forceRedraw = false, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), e3 && "xAxis" === t3 && e3.buildStacks(), this.isDirty || (this.isDirty = o2 || this.min !== this.old?.min || this.max !== this.old?.max)) : e3 && e3.cleanStacks(), i3 && this.panningState && (this.panningState.isDirty = true), M(this, "afterSetScale");
          }
        ...
        class w {
          ...
          getPosition(t3, e3, i3) {
            ...
            !l2 && o2.hoverSeries?.yAxis?.reversed && (C2 = !C2);
        ...
        class k {
          ...
          constructor(t3, e3) {
            this.hasDragged = false, this.lastValidTouch = {}, this.pinchDown = [], this.eventsToUnbind = [], this.options = e3, this.chart = t3, this.runChartClick = !!e3.chart.events?.click, this.pinchDown = [], this.lastValidTouch = {}, this.setDOMEvents(), g(this, "afterInit");
          }
          normalize(t3, e3) {
        ...
        class A {
          ...
          colorizeItem(t3, e3) {
            ...
            if (s2?.[e3 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
              ...
              o2?.css(S(e3 ? this.itemStyle : s3)), r2?.attr(p2({ stroke: d2 || t3.color })), n2 && n2.attr(p2(c2 && n2.isMarker ? t3.pointAttribs() : { fill: t3.color })), i3?.attr(p2({ fill: h2 || t3.color, "fill-opacity": h2 ? 1 : l2 ?? 0.75 }));
            }
        ...
        class X {
          ...
          translate() {
            ...
            for (p2 = 0; p2 < a2; p2++) {
              let t4;
              let a3 = n2[p2], y2 = a3.x, b2, v2, M2 = a3.y, C2 = a3.low, w2 = e3 && r2.stacking?.stacks[(this.negStacks && M2 < (c2 ? 0 : d2) ? "-" : "") + this.stackKey];
          ...
          applyZones() {
            let { area: t3, chart: e3, graph: i3, zones: s2, points: o2, xAxis: r2, yAxis: n2, zoneAxis: a2 } = this, { inverted: h2, renderer: l2 } = e3, d2 = this[`${a2}Axis`], { isXAxis: c2, len: p2 = 0 } = d2 || {}, u2 = (i3?.strokeWidth() || 0) / 2 + 1, g2 = (t4, e4 = 0, i4 = 0) => {
              h2 && (i4 = p2 - i4);
            ...
            if (s2.length && (i3 || t3) && d2 && I(d2.min)) {
              ...
              s2.forEach((e5) => {
                ...
                f2 = s3.reverse(), m2 = o3, h2 && (u3(v2), t3 && u3(b2)), a3 ? (a3.animate({ d: v2 }), d3?.animate({ d: b2 })) : (a3 = e5.clip = l2.path(v2), t3 && (d3 = e5.simpleClip = l2.path(b2))), i3 && e5.graph?.clip(a3), t3 && e5.area?.clip(d3);
              });
            } else
          ...
          render() {
            ...
            L(this, "render"), t3.plotGroup("group", "series", r2, n2, a2), t3.markerGroup = t3.plotGroup("markerGroup", "markers", r2, n2, a2), false !== i3.clip && t3.setClip(), h2 && t3.animate?.(true), t3.drawGraph && (t3.drawGraph(), t3.applyZones()), t3.visible && t3.drawPoints(), t3.drawDataLabels?.(), t3.redrawPoints?.(), i3.enableMouseTracking && t3.drawTracker?.(), h2 && t3.animate?.(), s2 || (h2 && o2.defer && (h2 += o2.defer), t3.animationTimeout = H(() => {
              t3.afterAnimate();
          ...
          searchKDTree(t3, e3, i3) {
            ...
            if (this.kdTree || this.buildingKdTree || this.buildKDTree(i3), this.kdTree)
              return function t4(e4, i4, a3, l2) {
                ...
                !function(t5, e5) {
                  let i5 = t5[o2], s3 = e5[o2], n3 = k(i5) && k(s3) ? i5 - s3 : null, a4 = t5[r2], l3 = e5[r2], d3 = k(a4) && k(l3) ? a4 - l3 : 0, c3 = h2 && e5.marker?.radius || 0;
          ...
          drawTracker() {
            let t3 = this, e3 = t3.options, i3 = e3.trackByArea, s2 = [].concat((i3 ? t3.areaPath : t3.graphPath) || []), o2 = t3.chart, r2 = o2.pointer, n2 = o2.renderer, a2 = o2.options.tooltip?.snap || 0, h2 = () => {
          ...
          update(t3, e3) {
            ...
            u2 = u2 || r2, g2 && (p2.push("data", "isDirtyData", "isDirtyCanvas", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"), false !== t3.visible && p2.push("area", "graph"), i3.parallelArrays.forEach(function(t4) {
              p2.push(t4 + "Data");
            }), t3.data && (t3.dataSorting && A(i3.options.dataSorting, t3.dataSorting), this.setData(t3.data, false))), t3 = R(o2, { index: void 0 === o2.index ? i3.index : o2.index, pointStart: n2?.series?.pointStart ?? o2.pointStart ?? i3.xData?.[0] }, !g2 && { data: i3.options.data }, t3, h2), g2 && t3.data && (t3.data = i3.options.data), (p2 = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"].concat(p2)).forEach(function(t4) {
        ...
        class tt {
          ...
          setZoomOptions() {
            ...
            this.zooming = __spreadProps(__spreadValues({}, e3), { type: $(t3.zoomType, e3.type), key: $(t3.zoomKey, e3.key), pinchType: $(t3.pinchType, e3.pinchType), singleTouch: $(t3.zoomBySingleTouch, e3.singleTouch, false), resetButton: U(e3.resetButton, t3.resetZoomButton) });
          }
          init(t3, e3) {
          ...
          render() {
            ...
            for (let e4 of (this.setTitle(), W(this, "beforeMargins"), this.getStacks?.(), this.getMargins(true), this.setChartSize(), t3)) {
        ...
        class P {
          ...
          renderStackTotals() {
            let t3 = this.axis, e3 = t3.chart, i3 = e3.renderer, s2 = this.stacks, o2 = t3.options.stackLabels?.animation, r2 = a(e3, o2 || false), n2 = this.stackTotalGroup = this.stackTotalGroup || i3.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
        ...
        return function(t3) {
          function e3() {
            return k(this).some((t4) => t4?.enabled);
          }
          ...
          function b(t4) {
            ...
            d(this, "drawDataLabels"), i4.hasDataLabels?.() && (e4 = this.initDataLabels(M2), t4.forEach((t5) => {
              let r2 = t5.dataLabels || [];
              y(S(x2, t5.dlOptions || t5.options?.dataLabels)).forEach((l4, d2) => {
                ...
                if (c3 && (k2 = f(l4[t5.formatPrefix + "Format"], l4.format), S2 = t5.getLabelConfig(), M3 = h(k2) ? n(k2, S2, s3) : (l4[t5.formatPrefix + "Formatter"] || l4.formatter).call(S2, l4), C = l4.rotation, !s3.styledMode && (v3.color = f(l4.color, v3.color, p(i4.color) ? i4.color : void 0, "#000000"), "contrast" === v3.color ? ("none" !== x3 && (P = x3), t5.contrastColor = a2.getContrast("auto" !== P && P || t5.color || i4.color), v3.color = P || !h(b3) && l4.inside || 0 > m(b3 || 0) || o3.stacking ? t5.contrastColor : u2) : delete t5.contrastColor, o3.cursor && (v3.cursor = o3.cursor)), w = { r: l4.borderRadius || 0, rotation: C, padding: l4.padding, zIndex: 1 }, s3.styledMode || (w.fill = "auto" === x3 ? t5.color : x3, w.stroke = "auto" === y2 ? t5.color : y2, w["stroke-width"] = l4.borderWidth), g(w, (t6, e5) => {
                  ...
                  o4 && !l4.useHTML && (T.setTextPath(t5.getDataLabelPath?.(T) || t5.graphic, o4), t5.dataLabelPath && !o4.enabled && (t5.dataLabelPath = t5.dataLabelPath.destroy())), T.added || T.add(e4), i4.alignDataLabel(t5, T, l4, void 0, A), T.isActive = true, r2[d2] && r2[d2] !== T && r2[d2].destroy(), r2[d2] = T;
                }
              });
              let l3 = r2.length;
              for (; l3--; )
                r2[l3] && r2[l3].isActive ? r2[l3].isActive = false : (r2[l3]?.destroy(), r2.splice(l3, 1));
          ...
          function k(t4) {
            ...
            return y(S(S(e4?.series?.dataLabels, e4?.[t4.type]?.dataLabels), t4.options.dataLabels));
          }
          ...
          function o2() {
            ...
            t3.visible && t3.hasDataLabels?.() && (e4.forEach((t4) => {
              ...
              (t4.dataLabels || []).forEach((e5, i5) => {
                ...
                0 === i5 && m2[t4.half].push(t4), !p(o4?.style?.width) && e5.getBBox().width > n2 && (e5.css({ width: Math.round(0.7 * n2) + "px" }), e5.shortened = true), e5.dataLabelPosition = this.getDataLabelPosition(t4, r4), k = Math.max(k, r4);
              });
            }), m2.forEach((e5, n3) => {
              ...
              l2 && (t3.sortByAngle(e5, n3 - 0.5), k > 0 && (f2 = Math.max(0, g2 - c2 - k), m3 = Math.min(g2 + c2 + k, i4.plotHeight), e5.forEach((t4) => {
                (t4.dataLabels || []).forEach((e6, s4) => {
                  ...
                  o4 && o4.distance > 0 && (o4.top = Math.max(0, g2 - c2 - o4.distance), o4.bottom = Math.min(g2 + c2 + o4.distance, i4.plotHeight), b2 = e6.getBBox().height || 21, t4.distributeBox = { target: (e6.dataLabelPosition?.natural.y || 0) - o4.top + b2 / 2, size: b2, rank: t4.y }, d2.push(t4.distributeBox));
                });
              }), h(d2, M = m3 + b2 - f2, M / 5)), e5.forEach((i5) => {
                (i5.dataLabels || []).forEach((h2) => {
                  let l3 = h2.options || {}, g3 = i5.distributeBox, f3 = h2.dataLabelPosition, m4 = f3?.natural.y || 0, b3 = l3.connectorPadding || 0, k2 = 0, M2 = m4, C = "inherit";
                  if (f3) {
              ...
              let s2 = (i4) => {
                for (let s3 of i4)
                  s3.visible && (s3.dataLabels || []).forEach((i5) => {
                    let o2 = i5.options || {};
                    i5.labelrank = a(o2.labelrank, s3.labelrank, s3.shapeArgs?.height), o2.allowOverlap ?? Number(o2.distance) > 0 ? (i5.oldOpacity = i5.opacity, i5.newOpacity = 1, d(i5, t3)) : e3.push(i5);
                  });
              };
        ...
        function m() {
          if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let { options: t3, yAxis: e3 } = this, i3 = "percent" === t3.stacking, o2 = s.plotOptions?.[this.type]?.borderRadius, r2 = x(t3.borderRadius, h(o2) ? o2 : {}), n2 = e3.options.reversed;
